...
Ansible is a software configuration management automation engine for infrastructure. It is agentless and allows us to connect to distant workstations using SSH keys. Ansible playbooks are written in yaml and provide simple text file inventory management.
